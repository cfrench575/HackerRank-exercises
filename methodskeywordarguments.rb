...
### differences in positional vs keyword arguments when calling function. Keyword uses ":" Whereas positional uses "="
...
def convert_temp(input, input_scale:, output_scale: 'celsius')
    ...
    elsif input_scale == output_scale
        output = input
    return output
    else
        raise "only acceptable scales for conversion are 'fahrenheit' 'celsius' and 'kelvin'";
    end
end


# convert_temp(10, input_scale: 'celsius', output_scale: 'kelvin')
# convert_temp(100, input_scale: 'celsius', output_scale: 'fahrenheit')

# convert_temp(10, input_scale: 'kelvin', output_scale: 'celsius')
# convert_temp(10, input_scale: 'kelvin', output_scale: 'fahrenheit')

# convert_temp(10, input_scale: 'fahrenheit', output_scale: 'kelvin')
# convert_temp(10, input_scale: 'fahrenheit', output_scale: 'celsius')

# convert_temp(10, input_scale: 'fahrenheit', output_scale: 'fahrenheit')

# convert_temp(10, input_scale: 'celsius')